...
export function MiniMaxH3Optimizations() {
  ...
  const solHelp = solSupported
    ...
    : `${modelOptions?.sol_attention_status?.reason || 'Sol Engine is unavailable in this runtime.'} On supported hardware, rebuild the Docker image to install or repair the H3 performance runtime.`
