    ...
    <div className="space-y-3">
      <div className="flex items-center gap-1.5">
        ...
        <InfoTooltip
          placement="bottom"
          label="About Recast"
          text={"Add one card for each person you want to replace. MuseForge isolates references, adds a face-detail view when useful, and preserves detected bystanders automatically.\n\nFast is recommended (8 steps). HQ uses the full 40-step schedule."}
        />
      </div>
        ...
        <div>
          <div className="mb-1 flex items-center gap-1">
            ...
            <InfoTooltip
              ...
              text="MuseForge scans the selected timeline. Each tile shows one character card at its strongest detected anchor; the same color remains assigned across shots."
            />
          </div>
